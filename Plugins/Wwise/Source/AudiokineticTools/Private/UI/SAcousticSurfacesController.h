...
private:
	...
	(See OnEditorModeEntered, OnEditorModeExited).
	*/
	...
	FAkPoly& GetAcousticSurfaceChecked(UAkSurfaceReflectorSetComponent* reflectorSet, int faceIndex);
	...
	void OnEditorModeEntered(const FEditorModeID& InEditorModeID);
	void OnEditorModeExited(const FEditorModeID& InEditorModeID);
